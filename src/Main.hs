...
main = do
    ...
    let blinky = Ghost Blinky Scatter (13, 11) GoRight 1 0.25 0
    let inky = Ghost Inky Scatter (13, 11) GoRight 1 0.25 0-- 13, 14
    let clyde = Ghost Clyde Scatter (13, 11) GoRight 1 0.25 0-- 14, 14
    let pinky = Ghost Pinky Scatter (13, 11) GoRight 1 0.25 0-- 13, 13
